...
const Terms = () => {
  ...
  return (
    <div style={{ padding: "30px 50px" }}>
      ...
      <p style={{ color: "#595959", fontSize: 14, fontWeight: 600 }}>Last updated February 12, 2023</p>
      <br />

      <p>
        These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of
        an entity (“you”) and ChipOnline Services DOO (“Company”, “we”, “us”, or “our”), concerning your access to and
        use of the <a href="https://chiponline.tech">https://chiponline.tech</a> website as well as any other media
        form, media channel, mobile website, or mobile application related, linked, or otherwise connected thereto
        (collectively, the “Site”). We are registered in Serbia and have our registered office at 24000, Serbia,
        Subotica, Korzo 1. The Website provides an online platform for electronic parts procurement, logistics,
        delivery, and sales services (the Website Offerings”). In order to help make the Site a secure environment for
        the provision and use of Website Offerings, all users are required to accept and comply with these Terms of Use.
        You agree that by accessing the Site and/or the Website Offerings, you have read, understood, and agree to be
        bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY
        PROHIBITED FROM USING THE SITE AND/OR THE WEBSITE OFFERINGS AND YOU MUST DISCONTINUE USE IMMEDIATELY.
      </p>
      <p>
      ...
      <p>
        ...
        use or register for the Site or use the Site Offerings.
      </p>

      <h2 style={{ fontSize: 19, color: "#000000" }}>INTELLECTUAL PROPERTY RIGHTS</h2>
      <p>
        Unless otherwise indicated, the Site and the Website Offerings are our proprietary property and all source code,
        ...
        personal use only. Except as expressly provided in these Terms of Use, no part of the Site or the Website
      ...
      <h2 style={{ fontSize: 19, color: "#000000" }}>USER REPRESENTATIONS</h2>
      <p>
        By using the Site or the Website Offerings, you represent and warrant that:(1) all registration information you
        submit will be true, accurate, current, and complete; (2) you will maintain the accuracy of such information and
        promptly update such registration information as necessary; (3) you have the legal capacity and you agree to
        comply with these Terms of Use; (4) you are not a minor in the jurisdiction in which you reside; (5) you will
        not access the Site or the Website Offerings through automated or non-human means, whether through a bot, script
        or otherwise; (6) you will not use the Site for any illegal or unauthorized purpose; and (7) your use of the
        Site or the Website Offerings will not violate any applicable law or regulation.
      </p>
      <p>
      ...
      <p>
        You may not use the Site or the Website Offerings for any illegal or unauthorized purpose nor may you, in the
        use of MaWebsiterketplace Offerings, violate any laws. Among unauthorized Website Offerings are the following:
        intoxicants of any sort; illegal drugs or other illegal products; alcoholic beverages; games of chance; and
        pornography or graphic adult content, images, or other adult products. Postings of any unauthorized products or
        content may result in immediate termination of your account and a lifetime ban from use of the Site.
      </p>
      <p>
        We are a service provider and make no representations as to the safety, effectiveness, adequacy, accuracy,
        availability, prices, ratings, reviews, or legality of any of the information contained on the Site or the
        Website Offerings displayed or offered through the Site. You understand and agree that the content of the Site
        does not contain or constitute representations to be reasonably relied upon, and you agree to hold us harmless
        from any errors, omissions, or misrepresentations contained within the Site’s content. We do not endorse or
        recommend any Website Offerings and the Site is provided for informational and advertising purposes only.
      </p>

      <h2 style={{ fontSize: 19, color: "#000000" }}>USER REGISTRATION</h2>
      <p>
        You may be required to register with the Site in order to access the Website Offerings. You agree to keep your
        password confidential and will be responsible for all use of your account and password. We reserve the right to
        remove, reclaim, or change a username you select if we determine, in our sole discretion, that such username is
        inappropriate, obscene, or otherwise objectionable.
      </p>

      <h2 style={{ fontSize: 19, color: "#000000" }}>WEBSITE OFFERINGS</h2>
      <p>
        We make every effort to display as accurately as possible the colors, features, specifications, and details of
        the Website Offerings available on the Site. However, we do not guarantee that the colors, features,
        specifications, and details of the Website Offerings will be accurate, complete, reliable, current, or free of
        other errors, and your electronic display may not accurately reflect the actual colors and details of the
        products. All Website Offerings are subject to availability, and we cannot guarantee that Website Offerings will
        be in stock. Certain Website Offerings may be available exclusively online through the Site. Such Website
        Offerings may have limited quantities and are subject to return or exchange only according to our Return Policy.
      </p>
      <p>
        We reserve the right to limit the quantities of the Website Offerings offered or available on the Site. All
        descriptions or pricing of the Website Offerings are subject to change at any time without notice, at our sole
        discretion. We reserve the right to discontinue any Website Offerings at any time for any reason. We do not
        warrant that the quality of any of the Website Offerings purchased by you will meet your expectations or that
        any errors in the Site will be corrected.
      </p>

      <h2 style={{ fontSize: 19, color: "#000000" }}>PURCHASES AND PAYMENT</h2>
      ...
      <br />
      <p>
        You agree to provide current, complete, and accurate purchase and account information for all purchases of the
        Website Offerings made via the Site. You further agree to promptly update account and payment information,
      ...
      <h2 style={{ fontSize: 19, color: "#000000" }}>RETURN/REFUNDS POLICY</h2>
      <p>Please review our Return Policy posted on the Site prior to making any purchases.</p>

      <h2 style={{ fontSize: 19, color: "#000000" }}>PROHIBITED ACTIVITIES</h2>
      <p>
      ...
      <ol style={{ marginLeft: 40 }}>
        ...
        <li>
          ...
          with the use, features, functions, operation, or maintenance of the Website Offerings.
        </li>
        <li>
        ...
        <li>
          Make any unauthorized use of the Website Offerings, including collecting usernames and/or email addresses of
          users by electronic or other means for the purpose of sending unsolicited email, or creating user accounts by
          automated means or under false pretenses.
        </li>
        <li>
          Use the Website Offerings as part of any effort to compete with us or otherwise use the Site and/or the
      ...
      <p>
        Any use of the Site or the Website Offerings in violation of the foregoing violates these Terms of Use and may
        result in, among other things, termination or suspension of your rights to use the Site and the Website
        Offerings.
      </p>
      ...
      <p>
        ...
        regarding the Site or the Website Offerings (`Submissions`) provided by you to us are non-confidential and shall
      ...
      <p>
        The Site may contain (or you may be sent via the Site or the Website Offerings) links to other websites
      ...
      <p>
        We care about data privacy and security. By using the Site or the Website Offerings, you agree to be bound by
        our Privacy Policy posted on the Site, which is incorporated into these Terms of Use. Please be advised the Site
        and the Website Offerings are hosted in Germany. If you access the Site or the Website Offerings from any other
        region of the world with laws or other requirements governing personal data collection, use, or disclosure that
        differ from applicable laws in Germany, then through your continued use of the Site, you are transferring your
        data to Germany, and you agree to have your data transferred to and processed in Germany.
      </p>
      ...
      <p>
        ...
        reserve the right to modify or discontinue all or part of the Website Offerings without notice at any time. We
        will not be liable to you or any third party for any modification, price change, suspension, or discontinuance
        of the Site or the Website Offerings.
      </p>
      <p>
        We cannot guarantee the Site and the Website Offerings will be available at all times. We may experience
        ...
        otherwise modify the Site or the Website Offerings at any time or for any reason without notice to you. You
        agree that we have no liability whatsoever for any loss, damage, or inconvenience caused by your inability to
        access or use the Site or the Website Offerings during any downtime or discontinuance of the Site or the Website
        Offerings. Nothing in these Terms of Use will be construed to obligate us to maintain and support the Site or
        the Website Offerings or to supply any corrections, updates, or releases in connection therewith.
      </p>
      ...
      <p>
        ...
        relate to the Website Offerings, including descriptions, pricing, availability, and various other information.
      ...
      <p>
        ...
        use of the Website Offerings; (2) breach of these Terms of Use; (3) any breach of your representations and
        ...
        Website Offerings with whom you connected via the Site. Notwithstanding the foregoing, we reserve the right, at
      ...
      <p>
        ...
        Website Offerings, as well as data relating to your use of the Website Offerings. Although we perform regular
        routine backups of data, you are solely responsible for all data that you transmit or that relates to any
        activity you have undertaken using the Website Offerings. You agree that we shall have no liability to you for
        any loss or corruption of any such data, and you hereby waive any right of action against us arising from any
      ...
      <p>
        These Terms of Use and any policies or operating rules posted by us on the Site or in respect to the Website
        ...
        as a result of these Terms of Use or use of the Website Offerings. You agree that these Terms of Use will not be
        construed against us by virtue of having drafted them. You hereby waive any and all defenses you may have based
        on the electronic form of these Terms of Use and the lack of signing by the parties hereto to execute these
        Terms of Use.
      </p>

      <h2 style={{ fontSize: 19, color: "#000000" }}>CONTACT US</h2>
      <p>
        In order to resolve a complaint regarding the Site or the Website Offerings or to receive further information
        regarding use of the Site or the Website Offerings, please contact us at:
      </p>

      <div style={{ fontWeight: 600, color: "#595959 " }}>ChipOnline Services DOO</div>
      <div style={{ fontWeight: 600, color: "#595959 " }}>24000, Serbia, Subotica, Korzo 1</div>
      <div style={{ fontWeight: 600, color: "#595959 " }}>Phone: +381 62 1257 226</div>
      <div style={{ fontWeight: 600, color: "#595959 " }}>info@chiponline.tech</div>
    </div>
  );
};
