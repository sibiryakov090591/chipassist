...
const Policy = () => {
  ...
  return (
    <div style={{ padding: "30px 50px" }}>
      <h1>Privacy Policy for ChipOnline Services DOO</h1>

      <p>
        At ChipOnline Services, accessible from https://chiponline.tech, one of our main priorities is the privacy of
        our visitors. This Privacy Policy document contains types of information that is collected and recorded by
        ChipOnline Services and how we use it.
      </p>
      ...
      <p>
        ...
        to the information that they shared and/or collect in ChipOnline Services. This policy is not applicable to any
      ...
      <p>
        ChipOnline Services follows a standard procedure of using log files. These files log visitors when they visit
      ...
      <p>
        You may consult this list to find the Privacy Policy for each of the advertising partners of ChipOnline
        Services.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on ChipOnline Services, which are sent directly to
      ...
      <p>
        Note that ChipOnline Services has no access to or control over these cookies that are used by third-party
        advertisers.
      </p>
      ...
      <p>
        ChipOnline Services`s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
