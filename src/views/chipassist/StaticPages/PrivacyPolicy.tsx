    ...
    <Page title="Privacy Policy" description="Privacy Policy">
      <div style={{ padding: "30px 50px" }}>
        ...
        <p>
          ...
          <noindex>ООО «Инелсо»</noindex> (далее — Оператор), управляющего платформой ICSearch.ru.
        </p>
        <p>
        ...
        <p>
          ...
          всей информации, которую Оператор может получить о посетителях веб-сайта https://icsearch.ru.
        </p>
        ...
        <p>
          ...
          обеспечивающих их доступность в сети интернет по сетевому адресу https://icsearch.ru.{" "}
        </p>
        <p>
        ...
        <p>
          ...
          Пользователю веб-сайта https://icsearch.ru.{" "}
        </p>
        <p>
        ...
        <p>2.10. Пользователь — любой посетитель веб-сайта https://icsearch.ru. </p>
        <p>
        ...
        <p>
          ...
          самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора info@icsearch.ru
        ...
        <p>
          ...
          уведомление посредством электронной почты на электронный адрес Оператора info@icsearch.ru с пометкой «Отзыв
        ...
        <p>
          ...
          персональных данных, обратившись к Оператору с помощью электронной почты info@icsearch.ru.{" "}
        </p>
        <p>
        ...
        <p>
          ...
          https://icsearch.ru/privacy_policy.{" "}
        </p>
      </div>
    </Page>
  );
