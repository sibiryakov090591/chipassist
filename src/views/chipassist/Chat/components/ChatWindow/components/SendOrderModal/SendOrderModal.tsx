...
const SendOrderModal: React.FC<Props> = ({ open, stock, onCloseModal, setIsSending, isExample_1, isExample_2 }) => {
  ...
  return !isExample_1 && !isExample_2 ? (
    <Modal
      open={open}
    ...
    <div className={clsx(commonClasses.paper, "fullScreen")}>
      <form className={classes.form}>
        ...
        <Box display="flex" justifyContent="space-between" alignItems="flex-end" mt="12px">
          <Box>1 / 2</Box>
          <Box mt={2} minWidth="70%" className={commonClasses.actionsRow}>
            <Button variant="contained" className={clsx(appTheme.buttonPrimary, appTheme.buttonMinWidth)}>
              {"Cancel"}
            </Button>
            <Button variant="contained" className={clsx(appTheme.buttonCreate, appTheme.buttonMinWidth)}>
              {"Next"}
            </Button>
          </Box>
        </Box>
